...
lyr_srm1_1.set('fieldAliases', {'id': 'id', 'building': 'building', 'floors': 'floors', 'population': 'population', });
lyr_srmhostels_2.set('fieldAliases', {'id': 'id', 'Population': 'Population', 'building ': 'building ', 'floors': 'floors', });
lyr_srm1_1.set('fieldImages', {'id': '', 'building': '', 'floors': '', 'population': '', });
lyr_srmhostels_2.set('fieldImages', {'id': '', 'Population': '', 'building ': '', 'floors': '', });
